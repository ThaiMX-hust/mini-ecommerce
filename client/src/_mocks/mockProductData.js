...
export const mockProductData = {
  ...
  description:
    "Chất liệu co dãn 4 chiều, thoáng khí, chống tia UV UPF50+. Thiết kế hiện đại, phù hợp cho mọi hoạt động ngoài trời.",
  ...
  options: [
    ...
    },
    {
      ...
      values: [
        ...
        {
          option_value_id: "bf3b2b1a-c21e-4b2e-8a7f-71de2e9a5e2a",
          value: "XL",
        },
      ],
    },
  ...
  variants: [
    {
      //thiếu "is_disabled": "boolean", và "option_name": "string", trong options
      product_variant_id: "7c4acd34-d706-4c4c-8cbf-9399cf2281f6",
      sku: "TMJ-UV-BLK-M",
      price: 219000,
      stock: 12,
      images: [
        "https://bizweb.dktcdn.net/thumb/large/100/399/392/products/h-ak8-pp-web-thumbnails-11.jpg?v=1753066546360",
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQibr_FJjXgUeS1Etzs6t8YI5fHFlG-HAR7Hg&s",
      ], // Thay bằng link ảnh thật để test
      options: [
        {
          product_option_id: "b0859f28-0cda-4a4d-a3d1-d75cf54fc285",
          values: [
